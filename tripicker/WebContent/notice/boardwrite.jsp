    ...
    <div class="container">
	 ...
	 <section class="container">
        <div class="col-sm-12 section-t8">
          <div class="row">
            <div class="col-md-7">
              <form class="form-a contactForm" action="./BoardWriteAction.bo" name="boardForm" method="post" ENCTYPE="multipart/form-data">
                <div class="row">
                  <div class="col-md-12 mb-3">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-lg form-control-a" name="nickname" value="">
                  ...
                  <div class="col-md-12">
                    ...
                    <button type="button" class="btn btn-a" onclick="location.href='./BoardList.bo'">목록</button>
                  </div>
                </div>
              </form>
            </div>         
