...
<body>
  ...
  <section class="property-single nav-arrow-b">
    ...
    <div class="row">
        ...
        <form action="./UserJoinAction.me" method="post" name="fr" onsubmit="return checkJoin();">
   		 <strong>* 아이디 </strong> <input type="text" class="form-control form-control-lg form-control-a" width="10" name="id" placeholder="4~10자리">
   		 	<input type="button" class="btn btn-b" value="중복확인" onclick="winopen()"><br>
   		 <strong>* 비밀번호 </strong><input type="password" class="form-control form-control-lg form-control-a" name="pass" placeholder="6~12자리">
    	 <strong>* 비밀번호 확인 </strong><input type="password" class="form-control form-control-lg form-control-a" name="checkPass">
    	 <strong>* 이름 : </strong><input type="text" class="form-control form-control-lg form-control-a" name="name"><br>
    	 <strong>* 닉네임 </strong> <input type="text" class="form-control form-control-lg form-control-a" name="nickname" placeholder="2~8자리" >
    	 	<input type="button" class="btn btn-b" value="중복확인"><br>
    	 <strong>* 나이 </strong> <!-- <input type="text" class="form-control form-control-lg form-control-a" > -->
	    	 			<select name="age">
						   ...
						   <option value="60">60대</option>
    	 							...
    	 							<br>
    	 <strong>* 성별 </strong> <input type="radio" class="form-control form-control-lg form-control-a" name="gender" value="M"> 남
    	 						<input type="radio" class="form-control form-control-lg form-control-a" name="gender" value="F"> 여<br>
      	 <strong>* 이메일 </strong> <input type="text" class="form-control form-control-lg form-control-a" name="email">
